                ...
                <div className={styles.bar}>
                    ...
                    <div className={styles.homeLeft}>
                        ...
                        <Link className={styles.HomeRightBtn} to="/registration">
                            <button className={`${styles.homeBTN} ${styles.fBtn}`}>sign up</button>
                        </Link>
                ...
                <div className={styles.container}>
                    <div className={styles.content}>
                        <div className={styles.login}>
                            ...
                            <input className={styles.inputWithIcon1} type="email" placeholder="Name Surname"/>
                            <input className={styles.inputWithIcon2} type="password" placeholder="Password"/>
                            <button className={`${styles.btn} ${styles.btn1}`} type="button">sign in</button>
                            <button type="button" className={`${styles.btn} ${styles.btn2}`}>sign up</button>
                            </form>
                        </div>
